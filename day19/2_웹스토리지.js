...
localStorage에 <input> 으로 입력받은 사용자의 아이디를 저장하고, 페이지를 새로고침해도 
그 값이 유지되는 것을 확인 하시오.
*/
function func1(){ 
        //*함수 실행 확인 로그
...
*/
//localStorage.removeItem('data'); //(방법1) 특정한 속성삭제
...
*/
// 1. 기존의 웹스토리지 불러오기/확인
let visit = sessionStorage.getItem( 'visit' ); console.log( visit ); //null
